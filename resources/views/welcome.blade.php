...
@section('content')
    <div class="container-fluid">
        <form action="{{ route('produit.index') }}" method="GET" class="mb-4">
            <div class="input-group shadow" style="width: 20%;">
                <input type="search" name="search" class="form-control rounded-pill border-0 bg-dark-input text-light" placeholder="Search" value="{{ request()->get('search') }}">
                <button class="btn btn-outline-secondary rounded-pill border-0 bg-dark-input text-light" type="button" onclick="clearSearch()">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center justify-content-center">
                                    ...
                                    <select class="form-select form-select-sm ms-2 shadow-sm bg-dark-input text-light border-0" data-produit-id="{{ $produit->id }}">
